...
pub const GCMarker = struct {
    ...
    pub fn markFromRoots(self: *GCMarker, roots: []const *GCObjectHeader) !void {
    ...
    fn scanObjectReferences(self: *GCMarker, obj: *GCObjectHeader, worklist: *std.ArrayListUnmanaged(*GCObjectHeader)) !void {
    ...
    fn conservativeScan(self: *GCMarker, obj: *GCObjectHeader, worklist: *std.ArrayListUnmanaged(*GCObjectHeader)) !void {
...
pub const MarkingValidator = struct {
    ...
    pub fn validateUniqueness(self: *MarkingValidator, objects: []const *GCObjectHeader) !bool {
    ...
    /// @pre objects 包含所有对象
    /// @post 返回是否所有可达对象都被标记
    pub fn validateCompleteness(self: *MarkingValidator, roots: []const *GCObjectHeader, objects: []const *GCObjectHeader) !bool {
