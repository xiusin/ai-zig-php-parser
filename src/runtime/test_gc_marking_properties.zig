...
/// 创建一个类型化的数组对象
fn createArrayObject(allocator: std.mem.Allocator, element_count: usize) !*TypedGCObject {
...
/// 创建一个类型化的对象实例
fn createObjectInstance(allocator: std.mem.Allocator, property_count: usize) !*TypedGCObject {
...
/// 创建一个类型化的闭包对象
fn createClosureObject(allocator: std.mem.Allocator, captured_count: usize) !*TypedGCObject {
