...
pub fn @"__main__"(ctx: runtime.Value, args: []const runtime.Value, allocator: std.mem.Allocator) !runtime.Value {
    ...
    // Block 0: entry
            // test_for_then_while.php:3
    // test_for_then_while.php:3
            // test_for_then_while.php:4
    // test_for_then_while.php:4
            // test_for_then_while.php:8
    // test_for_then_while.php:8
            // test_for_then_while.php:3
        reg_0 = 0;
            // test_for_then_while.php:3
    ...
    while (true) {
        // Header: for_cond_1
            // test_for_then_while.php:4
    // PHI: reg_33 (handled in terminator)
            // test_for_then_while.php:3
    // PHI: reg_31 (handled in terminator)
            // test_for_then_while.php:4
    reg_4 = reg_33;
        if (!(reg_33 < reg_5)) { @branchHint(.unlikely); break; }
        // Body: for_body_2
            // test_for_then_while.php:5
    reg_7 = reg_31;
            // test_for_then_while.php:5
    ...
    reg_10 = reg_33 + reg_9;
            // test_for_then_while.php:5
    reg_11 = reg_31 + reg_10;
            // test_for_then_while.php:5
        // Increment: for_loop_3 (x1)
            // test_for_then_while.php:4
    reg_12 = reg_33;
            // test_for_then_while.php:4
    reg_14 = reg_33 + reg_13;
            // test_for_then_while.php:4
        reg_33 = reg_14;
        reg_31 = reg_11;
    }
    ...
    reg_15 = 0;
        // test_for_then_while.php:8
    // Optimized: structured while loop
        // test_for_then_while.php:9
    reg_18 = 2;
    while (true) {
        // Header: while_cond_5
            // test_for_then_while.php:8
    // PHI: reg_34 (handled in terminator)
            // test_for_then_while.php:3
    // PHI: reg_32 (handled in terminator)
            // test_for_then_while.php:9
    reg_17 = reg_34;
        if (!(reg_34 < reg_18)) break;
        // Body: while_body_6
            // test_for_then_while.php:10
    reg_20 = reg_32;
            // test_for_then_while.php:10
    reg_21 = 10;
            // test_for_then_while.php:10
    reg_22 = reg_32 + reg_21;
            // test_for_then_while.php:10
            // test_for_then_while.php:11
    reg_23 = reg_34;
            // test_for_then_while.php:11
    reg_24 = 1;
            // test_for_then_while.php:11
    reg_25 = reg_34 + reg_24;
            // test_for_then_while.php:11
    }
    // Block 8: while_exit_7
        // test_for_then_while.php:14
    reg_26.release(runtime.runtime_allocator);
    reg_26 = runtime.Value.initString(static_strings[3]);
        // test_for_then_while.php:14
    reg_27 = reg_32;
        // test_for_then_while.php:14
    reg_28.release(runtime.runtime_allocator);
    reg_28 = try runtime.php_concat(reg_26, runtime.Value.initInt(reg_27), runtime.runtime_allocator);
        // test_for_then_while.php:14
    reg_29.release(runtime.runtime_allocator);
    reg_29 = runtime.Value.initString(static_strings[4]);
        // test_for_then_while.php:14
    reg_30.release(runtime.runtime_allocator);
    reg_30 = try runtime.php_concat(reg_28, reg_29, runtime.runtime_allocator);
        // test_for_then_while.php:14
    _ = try runtime.php_echo(reg_30);
