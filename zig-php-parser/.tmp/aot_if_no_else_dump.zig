...
pub fn @"__main__"(ctx: runtime.Value, args: []const runtime.Value, allocator: std.mem.Allocator) !runtime.Value {
    ...
    // Block 0: entry
            // test_if_no_else_sum.php:3
    // test_if_no_else_sum.php:3
            // test_if_no_else_sum.php:4
    // test_if_no_else_sum.php:4
            // test_if_no_else_sum.php:3
        reg_0 = 0;
            // test_if_no_else_sum.php:3
    ...
    // PHI: reg_25 (handled in terminator)
            // test_if_no_else_sum.php:3
    // PHI: reg_24 (handled in terminator)
            // test_if_no_else_sum.php:4
    reg_4 = reg_25;
        if (!(reg_25 < reg_5)) { @branchHint(.unlikely); break; }
        // Body: for_body_2
            // test_if_no_else_sum.php:5
    reg_7 = reg_25;
            // test_if_no_else_sum.php:5
    reg_8 = 2;
            // test_if_no_else_sum.php:5
    reg_9 = @rem(reg_25, reg_8);
            // test_if_no_else_sum.php:5
    reg_10 = 0;
            // test_if_no_else_sum.php:5
    reg_11 = try runtime.php_eq(runtime.Value.initInt(reg_9), runtime.Value.initInt(reg_10));
        if (reg_9 == reg_10) {
                // test_if_no_else_sum.php:6
    reg_12 = reg_24;
                // test_if_no_else_sum.php:6
    reg_13 = reg_25;
                // test_if_no_else_sum.php:6
    reg_14 = reg_24 + reg_25;
                // test_if_no_else_sum.php:6
                // test_if_no_else_sum.php:4
    reg_15 = reg_25;
                // test_if_no_else_sum.php:4
    ...
    // Block 5: for_exit_4
        // test_if_no_else_sum.php:9
    reg_18.release(runtime.runtime_allocator);
    reg_18 = runtime.Value.initString(static_strings[2]);
        // test_if_no_else_sum.php:9
    reg_19 = reg_24;
        // test_if_no_else_sum.php:9
    reg_20.release(runtime.runtime_allocator);
    reg_20 = try runtime.php_concat(reg_18, runtime.Value.initInt(reg_19), runtime.runtime_allocator);
        // test_if_no_else_sum.php:9
