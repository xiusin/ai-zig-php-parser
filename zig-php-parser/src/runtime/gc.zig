...
fn markValueGray(value: Value) void {
    switch (value.tag) {
        ...
        .struct_instance => value.data.struct_instance.markGray(),
...
fn scanValue(value: Value) void {
    switch (value.tag) {
        ...
        .struct_instance => value.data.struct_instance.scan(),
...
fn markValueBlack(value: Value) void {
    switch (value.tag) {
        ...
        .struct_instance => value.data.struct_instance.markBlack(),
...
fn collectValueWhite(value: Value, allocator: std.mem.Allocator) void {
    switch (value.tag) {
        ...
        .struct_instance => value.data.struct_instance.collectWhite(allocator),
