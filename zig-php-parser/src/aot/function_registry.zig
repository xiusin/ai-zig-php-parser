...
pub const registry = [_]FunctionMeta{
    ...
    .{ .php_name = "preg_replace", .runtime_name = "preg_replace", .needs_allocator = true, .category = .regex, .default_args = &[_]DefaultArgValue{ .none, .none, .none } },
    .{ .php_name = "preg_filter", .runtime_name = "preg_filter", .needs_allocator = true, .category = .regex, .default_args = &[_]DefaultArgValue{ .none, .none, .none } },
    .{ .php_name = "preg_replace_callback", .runtime_name = "php_preg_replace_callback", .needs_allocator = true, .category = .regex, .default_args = &[_]DefaultArgValue{ .none, .none, .none } },
