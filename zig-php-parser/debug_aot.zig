...
pub fn @"inner"(ctx: runtime.Value, args: []const runtime.Value, allocator: std.mem.Allocator) !runtime.Value {
    _ = &ctx;
    _ = &args;
    _ = allocator;
    _ = runtime;
    runtime.profiler.enterGlobal("inner");
    defer runtime.profiler.exitGlobal("inner");
    ...
    // Instructions
    // test_nested_ref.php:2
    // test_nested_ref.php:2
    reg_1 = if (args.len > 0 and !args[0].isMissing() and args[0].isRef()) args[0].asRef() else &null_val;
    reg_0 = reg_1;
    // test_nested_ref.php:2
    // test_nested_ref.php:3
    reg_2 = reg_1.*;
    // test_nested_ref.php:3
...
// MARKER: generateFunction called
pub fn @"outer"(ctx: runtime.Value, args: []const runtime.Value, allocator: std.mem.Allocator) !runtime.Value {
    _ = &ctx;
    _ = &args;
    _ = allocator;
    _ = runtime;
    runtime.profiler.enterGlobal("outer");
    defer runtime.profiler.exitGlobal("outer");
    // Register declarations
    var reg_1: *runtime.Value = undefined;
    _ = &reg_1;
    var reg_0: *runtime.Value = undefined;
    ...
    // Instructions
    // test_nested_ref.php:5
    // test_nested_ref.php:6
    // test_nested_ref.php:5
    reg_1 = if (args.len > 0 and !args[0].isMissing() and args[0].isRef()) args[0].asRef() else &null_val;
    reg_0 = reg_1;
    // test_nested_ref.php:5
    ...
    runtime.val_assign(reg_2, reg_0.*);
    // test_nested_ref.php:6
    reg_3 = try runtime.make_ref(reg_2, runtime.runtime_allocator);
    // test_nested_ref.php:6
    reg_4.release(runtime.runtime_allocator);
    reg_4 = try @"inner"(runtime.Value.initNull(), &[_]runtime.Value{reg_3}, runtime.runtime_allocator);
...
pub fn @"__main__"(ctx: runtime.Value, args: []const runtime.Value, allocator: std.mem.Allocator) !runtime.Value {
    ...
    // Instructions
    // test_nested_ref.php:9
    // test_nested_ref.php:8
    reg_0 = runtime.Value.initInt(10);
    // test_nested_ref.php:8
    try setGlobalVar("$val", reg_0);
    // test_nested_ref.php:9
    reg_2.release(runtime.runtime_allocator);
    reg_2 = getGlobalVar("$val");
    // test_nested_ref.php:9
    reg_1.*.release(runtime.runtime_allocator);
    _ = reg_2.retain();
    runtime.val_assign(reg_1, reg_2);
    // test_nested_ref.php:9
    reg_3 = try runtime.make_ref(reg_1, runtime.runtime_allocator);
    // test_nested_ref.php:9
    reg_4.release(runtime.runtime_allocator);
    reg_4 = try @"outer"(runtime.Value.initNull(), &[_]runtime.Value{reg_3}, runtime.runtime_allocator);
    if (runtime.hasException()) {
        @branchHint(.unlikely);
        // Cleanup on exception
        reg_4.release(runtime.runtime_allocator);
        ...
        reg_8 = runtime.Value.initNull();
        return error.RuntimeError;
    }
    // test_nested_ref.php:9
    reg_5.release(runtime.runtime_allocator);
    reg_5 = runtime.val_deref(reg_1).*;
    _ = reg_5.retain();
    // test_nested_ref.php:9
    try setGlobalVar("$val", reg_5);
    // test_nested_ref.php:10
    reg_6.release(runtime.runtime_allocator);
    reg_6 = getGlobalVar("$val");
    // test_nested_ref.php:10
    reg_7.release(runtime.runtime_allocator);
    reg_7 = runtime.Value.initString(static_strings[5]);
    // test_nested_ref.php:10
    reg_8.release(runtime.runtime_allocator);
    reg_8 = try runtime.php_concat(reg_6, reg_7, runtime.runtime_allocator);
    // test_nested_ref.php:10
    _ = try runtime.php_echo(reg_8);
    if (runtime.hasException()) {
        @branchHint(.unlikely);
        // Cleanup on exception
        reg_4.release(runtime.runtime_allocator);
...
fn registerAllFunctions() !void {
    try runtime.registerUserFunction("inner", @"inner");
    try runtime.registerUserFunction("outer", @"outer");
}
